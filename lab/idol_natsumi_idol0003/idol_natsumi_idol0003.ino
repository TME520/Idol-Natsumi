  ...
  if (isInGameMenuVisible) {
    switch (key) {
      ...
      case 182: case 's': case 'S':
        ...
        break;
      case 13: case ' ':
        // Placeholder: executeInGameMenu(inGameMenuSelection);
        break;
    }
    return;
  }
...
void drawGameBackground() {
  M5Cardputer.Display.drawJpgFile(SD, "/sprites/natsumi_11yo.jpg", 0, 0);
}
